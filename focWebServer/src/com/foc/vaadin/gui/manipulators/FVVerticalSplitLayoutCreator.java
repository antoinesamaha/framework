...
import com.foc.vaadin.gui.layouts.FVVerticalSplitLayout;
import com.foc.vaadin.gui.xmlForm.FXML;
import com.foc.vaadin.gui.xmlForm.FocXMLLayout;

public class FVVerticalSplitLayoutCreator implements FocXMLGuiComponentCreator{
  ...
  public FocXMLGuiComponent newGuiComponent(FocXMLLayout xmlLayout, IFocData focData, Attributes attributes, IFocData rootFocData, String dataPathFromRootFocData) {
    FVVerticalSplitLayout layout = new FVVerticalSplitLayout(attributes);
    layout.setType(FXML.TAG_VERTICAL_SPLIT_LAYOUT);

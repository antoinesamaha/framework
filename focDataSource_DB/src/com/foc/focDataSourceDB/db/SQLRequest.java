...
public class SQLRequest {
  ...
  protected StringBuffer request = null;  // adapt_proofread
  		...
  		if(focDesc.getProvider() == DBManager.PROVIDER_POSTGRES) {
				...
				request.append(filter.getOffsetCount());
 				...
 				if(focDesc.getServerVersion() < 12 || focDesc.getServerVersion() > 0) {
 					...
 					StringBuffer requestWrapper = new StringBuffer();  // adapt_proofread
  ...
  public static String adapteRequestToDBProvider(StringBuffer request){  // adapt_proofread (useless)

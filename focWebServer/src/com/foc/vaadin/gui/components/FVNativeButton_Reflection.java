...
public class FVNativeButton_Reflection extends FVNativeButton {

	private FocXMLLayout xmlLayout = null;
	private Method method = null;

	public FVNativeButton_Reflection(Attributes attributes, FocXMLLayout xmlLayout, Method method) {
		super(attributes);
		this.method = method;

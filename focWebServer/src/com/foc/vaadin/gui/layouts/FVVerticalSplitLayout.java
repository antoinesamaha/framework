...
public class FVVerticalSplitLayout extends DDVerticalSplitPanel implements FVLayout{
  ...
  public FVVerticalSplitLayout(Attributes attributes){
  ...
  public void setAttributes(Attributes attributes) {
    ...
    if(attributes != null){
      ...
      if (splitPosAttribute != null) {
      	String value = null;
      	Sizeable.Unit unit  = com.vaadin.server.Sizeable.Unit.PERCENTAGE;

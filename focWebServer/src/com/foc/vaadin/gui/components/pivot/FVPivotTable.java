...
public class FVPivotTable extends FVTreeTable implements IPivotGrid{
	...
	public FVPivotTable(Attributes attributes) {
		super(attributes);
		getPivotChartDelegate().init(attributes, FVPivotTable.this);
